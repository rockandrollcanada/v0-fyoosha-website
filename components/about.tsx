      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-20">
          <div className="aspect-square relative overflow-hidden image-glow transition-all duration-500">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fyoosha-drums-Mvpvb74x9Xd96FP0hVW6dqnLXH3nlP.jpg"
              alt="fyoosha drummer"
              fill
          ...
          <div className="aspect-square relative overflow-hidden image-glow transition-all duration-500">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fyoosha-g-qyTkWt9ZwkbvAGRe0BDfNFpiOISwqs.jpg"
              alt="fyoosha guitarist"
              fill
              className="object-cover hover:scale-105 transition-transform duration-700"
            />
          </div>
          <div className="aspect-square relative overflow-hidden image-glow transition-all duration-500">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fyoosha-8-lEDxU12QRAwCTYpZjT0YSamCa8ChUu.jpg"
              alt="fyoosha surreal artwork"
              fill
              className="object-cover hover:scale-105 transition-transform duration-700"
            />
          </div>
