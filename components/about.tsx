        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                <span className="font-[family-name:var(--font-brand)] font-black text-foreground">fyoosha</span> is an original instrumental recording duo - guitar and drums - creating a 
