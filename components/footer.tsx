      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Link 
              href="/" 
              className="font-[family-name:var(--font-brand)] text-3xl font-black tracking-tight text-foreground hover:text-primary transition-colors inline-block"
            >
              fyoosha
            </Link>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">
            <span className="font-[family-name:var(--font-brand)] font-black">fyoosha</span> - Toronto, Canada
          </p>
